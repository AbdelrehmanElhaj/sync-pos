    ...
    <header class="main-header no-print">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                ...
                <button onclick="openFullscreen();"  type="button" class="btn btn-secondary bg-green btn-flat pull-left m-8 btn-sm mt-10 popover-default hidden-xs" data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
                        <strong><i class="fa fas fa-desktop fa-lg" aria-hidden="true"></i></strong>
                </button>
                ...
                @if(in_array('pos_sale', $enabled_modules))
                    @can('sell.create')
                        <a href="{{action('SellPosController@create')}}" title="@lang('sale.pos_sale')" data-toggle="tooltip" data-placement="bottom" class="btn btn-flat pull-left m-8 btn-sm mt-10 btn-primary">
                ...
                @can('profit_loss_report.view')
                    <button type="button" id="view_todays_profit" title="{{ __('home.todays_profit') }}" data-toggle="tooltip" data-placement="bottom" class="btn btn-warning bg-red btn-flat pull-left m-8 btn-sm mt-10">
                ...
                <!-- <select name="language" class="lang language selectors ">
                    <option value="https://pos.sync-easy.net/home/ar" selected="">Arabic - العَرَبِيَّة</option>
                    <option value="https://pos.sync-easy.net/home/en">English</option>
                </select> -->
