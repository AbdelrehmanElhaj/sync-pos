...
@foreach($pdf_generation_for as $pdf_for)
	...
	<div class="width-100">
		<div class="width-100 f-right" align="center">
			<strong class="font-17">@lang('lang_v1.purchase_order')</strong>
		</div>
		{{-- <div class="width-50 f-right" align="right">
	...
	<div class="width-100 box">
		...
		<div class="width-40 f-right" style="text-align: center;">
			@if(!empty($logo))
	          <img src="{{$logo}}" alt="Logo" style="width: 85%; height: 60%; margin: auto;padding-right: 30px;">
	        @endif
	        <div style="margin-right: 30px;margin-top: 0px;padding-top: 0px;">
		...
		<div class="width-60 f-right" align="center" style="color: #22489B;padding-top: 5px;">
