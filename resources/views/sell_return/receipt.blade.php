	...
	<thead>
		<tr>
			...
			@if(!empty($receipt_details->invoice_heading))
				<p class="text-left text-muted-imp" style="font-weight: bold; font-size: 14px !important">{!! $receipt_details->invoice_heading !!}</p>
			@endif
...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50 color-555">
		...
		@if(!empty($receipt_details->logo))
			<img src="{{$receipt_details->logo}}" class="img" width="100px" height="100px">
			<br/>
		@endif
...
<div class="row color-555">
	<div class="col-xs-12">
		...
		<table class="table table-bordered table-no-top-cell-border">
			<thead>
				<tr style="background-color: #357ca5 !important; color: white !important; font-size: 14px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
