...
<div class="row">
	<div class="pos-form-actions">
		<div class="col-md-12">
			...
			@endif
			<button type="button" 
				class="btn bg-red btn-default btn-flat no-print @if(!empty($pos_settings['disable_suspend'])) @endif pos-express-finalize @if(!array_key_exists('card', $payment_types)) hide @endif @if($is_mobile) col-xs-6 @endif"
