    ...
    <body>
        <div class="ticket">
			...
			<div class="border-top textbox-info">
				<p class="f-right"><strong>{!! $receipt_details->invoice_no_prefix !!}</strong></p>
				<p class="f-left">
					{{$receipt_details->invoice_no}}
				</p>
			</div>
			<div class="textbox-info">
				<p class="f-right"><strong>{!! $receipt_details->date_label !!}</strong></p>
				<p class="f-left">
			...
			@if(!empty($receipt_details->due_date_label))
				<div class="textbox-info">
					<p class="f-right"><strong>{{$receipt_details->due_date_label}}</strong></p>
			...
			@if(!empty($receipt_details->sales_person_label))
				<div class="textbox-info">
					<p class="f-right"><strong>{{$receipt_details->sales_person_label}}</strong></p>
			...
			@if(!empty($receipt_details->commission_agent_label))
				<div class="textbox-info">
					<p class="f-right"><strong>{{$receipt_details->commission_agent_label}}</strong></p>
			...
			@if(!empty($receipt_details->brand_label) || !empty($receipt_details->repair_brand))
				<div class="textbox-info">
					<p class="f-right"><strong>{{$receipt_details->brand_label}}</strong></p>
			...
			@if(!empty($receipt_details->device_label) || !empty($receipt_details->repair_device))
				<div class="textbox-info">
					<p class="f-right"><strong>{{$receipt_details->device_label}}</strong></p>
			...
			@if(!empty($receipt_details->model_no_label) || !empty($receipt_details->repair_model_no))
				<div class="textbox-info">
					<p class="f-right"><strong>{{$receipt_details->model_no_label}}</strong></p>
			...
			@if(!empty($receipt_details->serial_no_label) || !empty($receipt_details->repair_serial_no))
				<div class="textbox-info">
					<p class="f-right"><strong>{{$receipt_details->serial_no_label}}</strong></p>
	                    ...
	                    <tr class="bb-lg">
	                        <td class="description">
	                        	<div style="display:flex; width: 100%;">
	                        		...
	                        		<p class="text-right m-0 mt-5 pull-right">{{$line['name']}}
	                        	...
	                        	<div style="display:flex; width: 100%;">
	                        		<p class="text-right width-60 quantity m-0 bw" style="direction: ltr;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                        			{{$line['quantity']}} 
	                        		...
	                        		@if(empty($receipt_details->hide_price))
	                        		<p class="text-left width-40 price m-0 bw">{{$line['line_total']}}</p>
	                        		@endif
	                        	</div>
	                        </td>
	                    </tr>
								...
								<tr>
									<td>
										<div style="display:flex;">
	                        				...
	                        				<p class="text-right width-60 m-0" style="margin:0;">
	                        					{{$modifier['name']}} 
	                        			...
	                        			<div style="display:flex;">
	                        				...
	                        				<p class="text-right width-50 quantity">
	                        					{{$modifier['quantity']}}
	                        					@if(empty($receipt_details->hide_price))
	                        					x {{$modifier['unit_price_inc_tax']}}
	                        					@endif
	                        				</p>
	                        				<p class="text-left width-50 price">
	                        					{{$modifier['line_total']}}
	                        				</p>
	                        			</div>		                             
			                        </td>
			...
			@if(!empty($receipt_details->payments))
				@foreach($receipt_details->payments as $payment)
					<div class="flex-box">
						...
						<p class="width-50 text-left">{{$payment['amount']}}</p>
					</div>
				@endforeach
			@endif
            <!-- Total Paid-->
