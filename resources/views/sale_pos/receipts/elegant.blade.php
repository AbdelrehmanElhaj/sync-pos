...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50">
		...
		<div class="text-left font-23">
			@if(!empty($receipt_details->invoice_no_prefix))
				<span class="pull-right">{!! $receipt_details->invoice_no_prefix !!}</span>
			@endif
		...
		@if(!empty($receipt_details->total_due) && !empty($receipt_details->total_due_label))
			<div class="bg-light-blue-active text-left font-23 padding-5">
			...
			<thead>
				<tr style="background-color: #357ca5 !important; color: white !important; font-size: 20px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					...
					@if(!empty($receipt_details->discounted_unit_price_label))
						...
						@endphp
					@endif
					<td style="text-right background-color: #357ca5 !important; color: white !important; width: {{$p_width}}% !important">
						{{$receipt_details->table_product_label}}
					</td>

					@if($receipt_details->show_cat_code == 1)
						<td style="text-right background-color: #357ca5 !important; color: white !important; width: 10% !important;">{{$receipt_details->cat_code_label}}</td>
					@endif
					
					<td style="text-right background-color: #357ca5 !important; color: white !important; width: 15% !important;">
			...
			<tbody>
				...
				@foreach($receipt_details->lines as $line)
					<tr>
						...
						<td>
							@if(!empty($line['image']))
								<img src="{{$line['image']}}" alt="Image" width="50" style="float: right; margin-left: 8px;">
							@endif
		...
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				<tr>
					...
					<td class="text-left font-23 padding-10" style="background-color: #357ca5 !important; color: white !important">
