				...
				<div class="row">
				  @if(!empty($receipt_details->logo))
					<div class="col-12 text-center mt-3 mb-3">
					  <img style="max-height: 100px; width: auto;" src="{{$receipt_details->logo}}" alt="Logo" class="img-fluid">
					</div>
				  @endif
				</div>
				<div class="row">
				  <div class="col-12 text-center">
					...
					@if(!empty($receipt_details->header_text))
					  <h4 class="mb-3">{!! $receipt_details->header_text !!}</h4>
					@endif
			  
					<!-- business information here -->
					@if(!empty($receipt_details->display_name))
					  <h5>{{$receipt_details->display_name}}</h5>
					@endif
					...
					@if(!empty($receipt_details->invoice_heading))
					  <h5 class="mb-3">{!! $receipt_details->invoice_heading !!}</h5>
					@endif
			</div>
