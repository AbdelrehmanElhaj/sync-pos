...
class BusinessUtil extends Util
{
    ...
    public function newBusinessDefaultResources($business_id, $user_id)
    {
        ...
        InvoiceScheme::create(['name' => 'الافتراضي',
                            'scheme_type' => 'blank',
                            'prefix' => '',
                            'start_number' => 1,
                            'total_digits' => 4,
        ...
        InvoiceLayout::create(['name' => 'الافتراضي',
                        'header_text' => null,
                        'invoice_no_prefix' => 'رقم الفاتورة :',
                        'invoice_heading' => 'فاتورة :',
                        'sub_total_label' => 'المجموع',
                        'discount_label' => 'الخصم',
                        'tax_label' => 'الضريبة',
                        'total_label' => 'مبلغ الفاتورة الإجمالي',
                        'show_landmark' => 1,
                        'show_city' => 1,
                        'show_state' => 1,
                        'show_zip_code' => 1,
                        ...
                        'total_due_label' => 'المجموع الغير مسدد',
                        'paid_label' => 'المبلغ المدفوع',
                        'show_payments' => 1,
                        'show_customer' => 1,
                        'customer_label' => 'الزبون',
                        'table_product_label' => 'اسم الصنف',
