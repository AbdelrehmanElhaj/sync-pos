...
return [
    ...
    'asset_maintenance_prefix' => 'بادئة صيانة الأصول',
    'last_maintenance_date' => 'تاريخ آخر صيانة',
    'maintenance_id' => 'معرف الصيانة',
    'view_all_maintenance' => 'عرض كل أعمال الصيانة',
    'view_own_maintenance' => 'عرض الصيانة الخاصة',
    'n_in_maintenance' => ':n في الصيانة',
    'datetime' => 'التاريخ والوقت',
    'unassigned' => 'غير معين',
    'download_attachments' => 'تحميل المرفقات',
    'asset_send_for_maintenance_notification' => 'إرسال إشعار صيانة',
    'enable_email' => 'تمكين البريد الإلكتروني',
    'asset_assigned_for_maintenance_notification' => 'الأصل سيرسل إشعار صيانة',
    'recipients' => 'المستلمون',
    'asset_assigned_for_maintenance' => 'الأصل :asset_code تم تسجيله للصيانة',
    'asset_sent_for_maintenance' => 'الأصل :asset_code أرسل للصيانة',
    'send_for_maintenance_details' => 'أرسل للحصول على تفاصيل الصيانة',
    'maintenance_note' => 'مذكرة الصيانة',
];