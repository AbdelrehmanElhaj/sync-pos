...
return [
    ...
    "machinery_and_equipment_desc" => "استخدم الآلات والمعدات لتتبع أجهزة الكمبيوتر ، بالإضافة إلى أي تركيبات أو أجهزة أخرى بخلاف الأثاث مملوكة ومستخدمة لعملك. يتضمن ذلك المعدات التي تركبها ، مثل الجرارات وجزازات العشب. ومع ذلك ، يجب تتبع السيارات والشاحنات بحسابات المركبات بدلاً من ذلك.    ",
    "other_fixed_assets" => "الأصول الثابتة الأخرى",
    "other_fixed_assets_desc" => "استخدام الأصول الثابتة الأخرى للأصول الثابتة التي لا تغطيها أنواع الأصول الأخرى. الأصول الثابتة هي ممتلكات مادية تستخدمها في عملك ولا تتوقع تحويلها إلى نقد أو استخدامها خلال عام واحد من العمليات العادية.    ",
    "vehicles" => "مركبات",
    "vehicles_desc" => "استخدم المركبات لتتبع قيمة المركبات التي تمتلكها شركتك وتستخدمها للأعمال. ويشمل ذلك المركبات على الطرق الوعرة والطائرات والمروحيات والقوارب. إذا كنت تستخدم مركبة للاستخدام الشخصي والتجاري على حدٍ سواء ، فاستشر المحاسب الخاص بك لمعرفة كيفية تتبع قيمتها.    ",
    "accumulated_amortisation_of_non-current_assets" => "الاستهلاك المتراكم للأصول غير المتداولة",
    "accumulated_amortisation_of_non-current_assets_desc" => "استخدم الاستهلاك المتراكم للأصول غير المتداولة لتتبع المقدار الذي استهلكته من الأصول التي يكون نوعها أصولاً غير متداولة.    ",
    "assets_held_for_sale" => "أصول محتفظ بها للبيع",
    "assets_held_for_sale_desc" => "استخدم الأصول المحتفظ بها للبيع لتتبع أصول الشركة المتاحة للبيع والتي لا يُتوقع الاحتفاظ بها لفترة طويلة من الزمن.    ",
    "deferred_tax" => "الضريبة المؤجلة",
    "deferred_tax_desc" => "استخدم الضريبة المؤجلة للالتزامات الضريبية أو الأصول التي سيتم استخدامها في الفترات المحاسبية المستقبلية.    ",
    "goodwill" => "شهرة محل",
    "goodwill_desc" => "استخدم شهرة المحل فقط إذا كنت قد استحوذت على شركة أخرى. إنه يمثل الأصول غير الملموسة للشركة المستحوذ عليها والتي أعطتها ميزة ، مثل العلاقات الحكومية المواتية ، أو الاسم التجاري ، أو التصنيفات الائتمانية المتميزة ، أو الموقع ، أو الإدارة العليا ، أو قوائم العملاء ، أو جودة المنتج ، أو علاقات العمل الجيدة.    ",
    "intangible_assets" => "الأصول غير الملموسة",
    "intangible_assets_desc" => "استخدم الأصول غير الملموسة لتتبع الأصول غير الملموسة التي تخطط لإطفاءها. تشمل الأمثلة الامتيازات وقوائم العملاء وحقوق التأليف والنشر وبراءات الاختراع.    ",
    "lease_buyout" => "إيجار الاستحواذ",
    "lease_buyout_desc" => "استخدم ايجار الاستحواذ لتتبع مدفوعات الإيجار التي سيتم تطبيقها على شراء أصل مؤجر. لا يمكنك تتبع الأصل المؤجر نفسه حتى تشتريه.    ",
    "licences" => "التراخيص",
    "licences_desc" => "استخدم التراخيص لتتبع التراخيص غير المهنية للحصول على إذن للمشاركة في نشاط ، مثل بيع الكحول أو البث الإذاعي. بالنسبة للرسوم المرتبطة بالتراخيص المهنية الممنوحة للأفراد ، استخدم بدلاً من ذلك حساب مصروفات الرسوم القانونية والمهنية.    ",
    "long-term_investments" => "استثمارات طويلة الأجل",
    "long-term_investments_desc" => "استخدم الاستثمارات طويلة الأجل لتتبع الاستثمارات التي لها تاريخ استحقاق أطول من عام واحد    .",
    "organisational_costs" => "التكاليف التنظيمية",
    "organisational_costs_desc" => "استخدم التكاليف التنظيمية لتتبع التكاليف المتكبدة عند تكوين شراكة أو شركة. تشمل التكاليف التكاليف القانونية والمحاسبية اللازمة لتنظيم الشركة وتسهيل إيداع المستندات القانونية والأوراق الأخرى.    ",
    "other_non-current_assets" => "أصول غير متداولة أخرى",
    "other_non-current_assets_desc" => "استخدم الأصول الأخرى غير المتداولة لتتبع الأصول التي لا تغطيها الأنواع الأخرى. الأصول غير المتداولة هي أصول طويلة الأجل من المتوقع أن توفر قيمة لأكثر من عام واحد    .",
    "security_deposits" => "الودائع الأمنة",
    "security_deposits_desc" => "استخدم ودائع الضمان لتتبع الأموال التي دفعتها لتغطية أي تكاليف محتملة تتكبدها نتيجة التلف أو الخسارة أو السرقة. يجب إعادة الأموال إليك في نهاية العقد. إذا قبلت الدفعات المقدمة أو الدفعات المقدمة أو ودائع التأمين أو أنواع الودائع الأخرى ، فاستخدم حساب الخصوم الأخرى مع نوع التفاصيل الخصوم المتداولة الأخرى.    ",
    "accounts_payable_(a/p)" => "الحسابات الدائنة (A / P)",
    "accounts_payable_(a/p)_desc" => "الحسابات الدائنة (وتسمى أيضًا A / P ، أو الذمم التجارية الدائنة الأخرى ، أو الدائنون) تتعقب المبالغ التي تدين بها لمورديك.    ",
    "credit_card" => "بطاقة الائتمان",
    ...
    "advertising/promotional" => "إعلاني / ترويجي    ",
    ...
    "income_tax_expense" => "مصروف ضريبة الدخل    ",
    ...
    "loss_on_discontinued_operations,_net_of_tax" => "خسارة من العمليات المتوقفة ، صافية من الضريبة    ",
    ...
    "management_compensation" => "تعويضات الإدارة    ",
    ...
    "office/general_administrative_expenses" => "المكتب / المصاريف الادارية العامة    ",
    ...
    "other_miscellaneous_service_cost" => "تكلفة خدمات متنوعة أخرى    ",
    ...
    "rent_or_lease_of_buildings" => "إيجار أو إيجار المباني    ",
