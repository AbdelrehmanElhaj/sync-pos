...
class JournalEntryController extends Controller
{
                ...
                ->addColumn(
                    'action', function ($row) {
                        ...
                        if(auth()->user()->can('accounting.view_journal')) {
                            $html .= '<li>
                                    <a href="'.action('\Modules\Accounting\Http\Controllers\JournalEntryController@show', [$row->id]).'">
    ...
    public function create()
    {
        ...
        return view('accounting::journal_entry.create', compact('business_locations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $acc_trans_mapping->location_id = $location_id;
            ...
            foreach($account_ids as $index => $account_id){
                if(!empty($account_id)){
                    ...
                    if(!empty($notes[$index])){
                        $transaction_row['notes'] = $notes[$index];
                    }
    ...
    public function show($id)
        {
            ...
            $journal_entry = AccountingAccTransMapping::where('business_id', $business_id)
                ->where('type', 'journal_entry')
                ->where('id', $id)
                ->firstOrFail();
            ...
            return view('accounting::journal_entry.show')
            ->with(compact('journal_entry', 'accounts_transactions'));
        }
