        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    @endforeach 
                        <li><a href="#category0" class="menu">@lang( 'productcatalogue::lang.uncategorized' )</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div><!--/.container-fluid -->
        </nav>
...
<section class="content pt-0">
    <div class="container">
        @foreach($products as $product_category)
            <div class="row">
                <div class="col-md-12">
                    <h2 class="page-header" id="category{{$product_category->first()->category->id ?? 0}}">{{$product_category->first()->category->name ?? 'غير مصنف'}}</h2>
                </div>
            </div>
