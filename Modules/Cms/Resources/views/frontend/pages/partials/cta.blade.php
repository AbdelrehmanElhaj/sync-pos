    ...
    <div class="row justify-content-center px-lg-5">
        <div class="col-lg-8 mx-auto mb-3 mb-lg-0">
            ...
            <p class="block-29__paragraph mt-3">
                تحدث إلى أحد خبراء منتجاتنا. نحن هنا لمساعدتك في بدء عملك.
            </p>
        </div>
        <div class="col-lg-4 mx-auto mt-4 mt-xl-0 d-flex flex-row-reverse align-items-center justify-content-center justify-content-lg-start">
            <div class="text-center">
                <a class="btn btn-secondary" href="{{ route('business.getRegister') }}">
                    <span class="mx-1">
                        جرب الآن
                    </span>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="mx-1 bi bi-arrow-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
