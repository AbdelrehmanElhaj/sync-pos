...
<div class="block-44">
    ...
    <div class="container">
        <div class="row flex-column flex-md-row px-2 justify-content-center">
            ...
            @endif
            <p class="block-41__copyrights col col-md-8 text-xxl-end text-xl-end text-lg-end text-md-end text-sm-center left">
                &copy; &nbsp;{{ date('Y')}} &nbsp;{{config('app.name', 'SYNC_EASY')}}. &nbsp;جميع الحقوق محفوظة.
            </p>
        </div>
    </div>
  </div>
