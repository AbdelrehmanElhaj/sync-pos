                    ...
                    <li class="flex-grow-1">
                        <ul class="nav nav--lg-side flex-column-reverse flex-lg-row-reverse list-unstyled align-items-center p-0">
                            <li class="flex-grow-1">
                                <ul class="nav nav--lg-side flex-column-reverse flex-lg-row-reverse list-unstyled align-items-center p-0">
                                    <li class="hero-nav__item">
                                        <!--<a href="{{ route('business.getRegister') }}" target="_blank"
                            ...
                            @if($__blog_count >= 1)
                                <li class="hero-nav__item">
                                    <a href="{{action('\Modules\Cms\Http\Controllers\CmsController@getBlogList')}}" class="hero-nav__link">
                                        {{__('cms::lang.blogs')}}
                                    </a>
                                </li>
                            @endif
                                        ...
                                        <div class="row flex-wrap">
                                            <div class="col-lg-12">
                                                @foreach($__pages as $page)
                                                    <a href="{{ action('\Modules\Cms\Http\Controllers\CmsPageController@showPage', ['page' => $page->slug]) }}" class="dropdown__link">
                                                        <!-- Don't remove this empty "span" -->
                                                        <span class="mx-2"></span>
                                                        <!-- ------------------------------ -->
                            ...
                            @endif
                            <li class="hero-nav__item">
                                <a href="{{route('cms.contact.us')}}" class="hero-nav__link">تواصل معنا</a>
                            </li>
                            @if(Route::has('pricing') && config('app.env') != 'demo')
                                <li class="hero-nav__item">
                                    <a href="{{ action('\Modules\Superadmin\Http\Controllers\PricingController@index') }}" class="hero-nav__link">
